...
namespace Aliyun.MNS.Util
{
    ...
    public static partial class AliyunSDKUtils
    {
        ...
        static void BuildUserAgentString()
        {
            ...
            _sdkUserAgent = string.Format(CultureInfo.InvariantCulture, "{0}/{1} .NET Runtime/{2} .NET Core/{3} OS/{4}",
                _userAgentBaseName,
                _versionNumber,
                DetermineRuntime(),
                DetermineFramework(),
        ...
        {
            return string.Format(CultureInfo.InvariantCulture, "{0}.{1}", Environment.Version.Major,
        ...
        {
            get { return GetFormattedTimestampRFC822(0); }
        }
