...
namespace Aliyun.MNS.Sample
{
    ...
    public class AsyncOperationSample
    {
         ...
         void CreateQueueCallback(IAsyncResult ar)
        {
         ...
         void DeleteQueueCallback(IAsyncResult ar)
        {
            try
            {
         ...
         void ListQueueCallback(IAsyncResult ar)
        {
            try
            {
         ...
         void GetQueueAttributesCallback(IAsyncResult ar)
        {
            try
            {
         ...
         void SetQueueAttributesCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue)ar.AsyncState;
        ...
        #region Message Releated Callback Methods
         ...
         void BatchSendMessageCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue)ar.AsyncState;
         ...
         void ReceiveMessageCallback(IAsyncResult ar)
        {
         ...
         void BatchReceiveMessageCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue)ar.AsyncState;
         ...
         void ChangeMessageVisibilityCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue) ar.AsyncState;
         ...
         void PeekMessageCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue) ar.AsyncState;
         ...
         void BatchPeekMessageCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue)ar.AsyncState;
         ...
         void DeleteMessageCallback(IAsyncResult ar)
        {
         ...
         void BatchDeleteMessageCallback(IAsyncResult ar)
        {
            try
            {
                var nativeQueue = (Queue)ar.AsyncState;
